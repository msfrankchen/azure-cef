// <copyright file="BillingEventSource.cs" company="Microsoft Corporation">
...
{
    [EventSource(Name = "Microsoft-Azure-EngagementFabric-Billing")]
    ...
    internal sealed class BillingEventSource : EventSourceBase
    {
        public static readonly BillingEventSource Current = new BillingEventSource();

        static BillingEventSource()
        {
