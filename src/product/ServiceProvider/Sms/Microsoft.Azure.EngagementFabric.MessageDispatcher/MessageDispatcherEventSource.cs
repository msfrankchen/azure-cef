// <copyright file="MessageDispatcherEventSource.cs" company="Microsoft Corporation">
...
{
    [EventSource(Name = "Microsoft-Azure-EngagementFabric-MessageDispatcher")]
    ...
    public sealed class MessageDispatcherEventSource : EventSourceBase
    {
        public static readonly MessageDispatcherEventSource Current = new MessageDispatcherEventSource();

        static MessageDispatcherEventSource()
        {
        ...
        private MessageDispatcherEventSource()
            : base()
        {
        }
        ...
        {
            this.WriteEvent(VerboseEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
        ...
        {
            this.WriteEvent(InfoEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
        ...
        {
            this.WriteEvent(WarningEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
        ...
        {
            this.WriteEvent(ErrorEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
        ...
        {
            this.WriteEvent(CriticalEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
        ...
        {
            this.WriteEvent(UnexpectedEventId, trackingId, $"{MessageDispatcher.AppName}-{callerId}", callerState, operation, operationState, msg, line, GetFileName(file));
        }
    }
}
