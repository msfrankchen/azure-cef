...
namespace Microsoft.Azure.EngagementFabric.SmsProvider.Billing
{
    public class BillingAgent : BillingStore
    {
        ...
        protected override async Task PushUsageInnerLoopAsync(CancellationToken cancellationToken)
        {
            ...
            {
                SmsProviderEventSource.Current.ErrorException(SmsProviderEventSource.EmptyTrackingId, this, nameof(this.PushUsageInnerLoopAsync), OperationStates.Failed, "PushUsageInnerLoopAsync failed with exception", ex);
            }
        }
        ...
        protected override async Task PushToTargetAsync(IEnumerable<ResourceUsageRecord> records, Guid batchId, CancellationToken cancellationToken)
        {
            ...
            SmsProviderEventSource.Current.Info(SmsProviderEventSource.EmptyTrackingId, this, nameof(this.PushUsageInnerLoopAsync), OperationStates.Succeeded, $"Pushed {records.Count()} record(s) to Billing Service");
        }
    }
}
