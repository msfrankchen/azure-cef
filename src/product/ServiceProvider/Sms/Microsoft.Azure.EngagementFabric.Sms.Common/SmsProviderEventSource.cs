// <copyright file="SmsProviderEventSource.cs" company="Microsoft Corporation">
...
{
    [EventSource(Name = "Microsoft-Azure-EngagementFabric-Sms")]
    ...
    public sealed class SmsProviderEventSource : EventSourceBase
    {
        public static readonly SmsProviderEventSource Current = new SmsProviderEventSource();

        static SmsProviderEventSource()
        {
        ...
        private SmsProviderEventSource()
            : base()
        {
        }
