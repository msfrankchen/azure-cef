// -----------------------------------------------------------------------
// <copyright file="OtpProviderEventSource.cs" company="Microsoft Corporation">
...
{
    [EventSource(Name = "Microsoft-Azure-EngagementFabric-Otp")]
    ...
    public sealed class OtpProviderEventSource : EventSourceBase
    {
        public static readonly OtpProviderEventSource Current = new OtpProviderEventSource();

        static OtpProviderEventSource()
        {
        ...
        private OtpProviderEventSource()
            : base()
        {
        }
