...
namespace Microsoft.Azure.EngagementFabric.OtpProvider.Configuration
{
    public static class ExceptionHandler
    {
        ...
        public static void ProcessException(object caller, Exception ex, string trackingId = null)
        {
            ...
            {
                trackingId = OtpProviderEventSource.EmptyTrackingId;
            }

#if DEBUG
            OtpProviderEventSource.Current.ErrorException(trackingId, caller, nameof(ExceptionHandler), OperationStates.Failed, string.Empty, ex);
#else
