// -----------------------------------------------------------------------
// <copyright file="SocialProviderEventSource.cs" company="Microsoft Corporation">
...
{
    [EventSource(Name = "Microsoft-Azure-EngagementFabric-SocialLogin")]
    ...
    public sealed class SocialProviderEventSource : EventSourceBase
    {
        public static readonly SocialProviderEventSource Current = new SocialProviderEventSource();

        static SocialProviderEventSource()
        {
        ...
        private SocialProviderEventSource()
            : base()
        {
        }
